...
sealed class ClientException implements AppException {
  const ClientException(this.cause, this.stackTrace);
...
class NullDataFoundClientException extends ClientException {
  const NullDataFoundClientException(super.cause, super.stackTrace);
...
class ServerClientException extends ClientException {
  const ServerClientException(super.cause, super.stackTrace);
...
class IncorrectJsonClientException extends ClientException {
  const IncorrectJsonClientException(super.cause, super.stackTrace);
...
class UnknownClientException extends ClientException {
  const UnknownClientException(super.cause, super.stackTrace);
