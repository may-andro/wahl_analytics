...
sealed class CareerException implements AppException {
  const CareerException(this.cause, this.stackTrace);
...
class UploadDocumentFailureException extends CareerException {
  const UploadDocumentFailureException(super.cause, super.stackTrace);
...
class UnknownCareerException extends CareerException {
  const UnknownCareerException(super.cause, super.stackTrace);
