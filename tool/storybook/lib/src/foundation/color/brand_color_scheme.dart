...
@widgetbook.UseCase(name: 'Brand Color Scheme', type: BrandColorScheme)
...
class BrandColorScheme extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ColorAvatarBuilderWidget([
      ...
      ColorAvatar(colorScheme.onPrimaryContainer.color, 'On Primary Container'),
      ColorAvatar(colorScheme.secondary.color, 'Secondary'),
      ColorAvatar(colorScheme.onSecondary.color, 'On Secondary'),
      ColorAvatar(colorScheme.secondaryContainer.color, 'Secondary Container'),
      ColorAvatar(
