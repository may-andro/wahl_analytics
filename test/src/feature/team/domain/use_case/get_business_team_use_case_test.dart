...
void main() {
  group('GetBusinessTeamUseCase', () {
    ...
    test(
      'should return BusinessTeamFailure '
      'when NullDataFoundTeamException is thrown',
      () async {
    ...
    test(
      'should return BusinessTeamFailure '
      'when ServerTeamException thrown',
      () async {
        mockTeamRepository.mockGetBusinessTeamThrowsException(
    ...
    test(
      'should return BusinessTeamFailure '
      'when IncorrectJsonTeamException thrown',
      () async {
        mockTeamRepository.mockGetBusinessTeamThrowsException(
    ...
    test(
      'should return BusinessTeamFailure '
      'when UnknownTeamException thrown',
      () async {
        mockTeamRepository.mockGetBusinessTeamThrowsException(
