...
void main() {
  group('GetBusinessContactUseCase', () {
    ...
    test('should return business contact', () async {
    ...
    test('should return BusinessContactFailure '
        'when NullDataFoundContactException is thrown', () async {
    ...
    test('should return BusinessContactFailure '
        'when ServerContactException thrown', () async {
      mockContactRepository.mockGetBusinessContactThrowsException(
    ...
    test('should return BusinessContactFailure '
        'when IncorrectJsonContactException thrown', () async {
      mockContactRepository.mockGetBusinessContactThrowsException(
    ...
    test('should return BusinessContactFailure '
        'when UnknownContactException thrown', () async {
      mockContactRepository.mockGetBusinessContactThrowsException(
