...
void main() {
  group(InvalidShortDescriptionFailure, () {
    ...
    test('should return $NullShortDescriptionFailure when input is null',
        () async {
    ...
    test('should return $EmptyShortDescriptionFailure when input is empty',
        () async {
    ...
    test('should return false when message is less than 40 characters',
        () async {
