...
void main() {
  group('GetBusinessClientUseCase', () {
    ...
    test('should return business client', () async {
    ...
    test('should return BusinessClientFailure '
        'when NullDataFoundClientException is thrown', () async {
    ...
    test('should return BusinessClientFailure '
        'when ServerClientException thrown', () async {
      mockClientRepository.mockGetBusinessClientThrowsException(
    ...
    test('should return BusinessClientFailure '
        'when IncorrectJsonClientException thrown', () async {
      mockClientRepository.mockGetBusinessClientThrowsException(
    ...
    test('should return BusinessClientFailure '
        'when UnknownClientException thrown', () async {
      mockClientRepository.mockGetBusinessClientThrowsException(
